...
import 'package:course_dilaundry/datasource/user_datasource.dart';
import 'package:course_dilaundry/page/auth/register_page.dart';
import 'package:course_dilaundry/page/dashboard_page.dart';
    ...
    UserDatasource.login(
      ...
      value.fold(
        ...
        (result) {
          ...
          Nav.pushReplace(context, const DashboardPage());
        },
      );
    });
  }
