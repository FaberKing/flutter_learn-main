...
import 'package:course_bank_sha/blocs/tip/tip_bloc.dart';
import 'package:course_bank_sha/blocs/transaction/transaction_bloc.dart';
...
import 'package:course_bank_sha/ui/widget/home_latest_transaction_item.dart';
import 'package:course_bank_sha/ui/widget/home_service_item.dart';
import 'package:course_bank_sha/ui/widget/home_tips_item.dart';
import 'package:course_bank_sha/ui/widget/home_user_item.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

import '../../model/transfer_form_model.dart';
                ...
                builder: (context, state) {
                  if (state is TipSuccess) {
                    return Wrap(
                      spacing: 17,
                      runSpacing: 18,
                      children: state.tips.map((e) {
                        return HomeTipsItem(tips: e);
                      }).toList(),
                    );
                  }
                  return const Center(
