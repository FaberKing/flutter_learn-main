...
import 'package:course_bank_sha/model/signin_form_model.dart';
import 'package:course_bank_sha/model/signup_form_model.dart';
...
import 'package:course_bank_sha/services/wallet_service.dart';
    ...
    on<AuthEvent>((event, emit) async {
      if (event is AuthCheckEmail) {
        try {
          ...
          final res = await AuthService().checkEmailExist(event.email);
